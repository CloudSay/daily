...
for(let i=1; i<21;i++){
	str += `<li>
				<a href="#">
					<img src="./static/img-index/brand${i}.jpg" />
				</a>
			</li>`
}
$(".brand").html(str);
...
for(var j= 0 ;j<6; j++){
		 ...
		 str2 +=`<div >
						<dl>
							<dt>
								<a href="#"><img src="./static/img-index/m-img${j*6+1}.jpg" /></a>
							</dt>
							<dd>
						...
						<dl>
							<dt>
								<a href="#"><img src="./static/img-index/m-img${j*6+2}.jpg" /></a>
							</dt>
							<dd>
								<span><a href="#">￥ 8.8</a></span>
								<p>新款OPPOR9/r11S/A59/vivoX7/x9/X20/y67苹果6S/7/8plus手机壳</p>
						...
						<dl>
							<dt>
								<a href="#"><img src="./static/img-index/m-img${j*6+3}.jpg" /></a>
							</dt>
							<dd>
								<span><a href="#">￥ 8.8</a></span>
								<p>新款OPPOR9/r11S/A59/vivoX7/x9/X20/y67苹果6S/7/8plus手机壳</p>
						...
						<dl>
							<dt>
								<a href="#"><img src="./static/img-index/m-img${j*6+4}.jpg" /></a>
							</dt>
							<dd>
								<span><a href="#">￥ 8.8</a></span>
								<p>新款OPPOR9/r11S/A59/vivoX7/x9/X20/y67苹果6S/7/8plus手机壳</p>
						...
						<dl>
							<dt>
								<a href="#"><img src="./static/img-index/m-img${j*6+5}.jpg" /></a>
							</dt>
							<dd>
								<span><a href="#">￥ 8.8</a></span>
								<p>新款OPPOR9/r11S/A59/vivoX7/x9/X20/y67苹果6S/7/8plus手机壳</p>
						...
						<dl>
							<dt>
								<a href="#"><img src="./static/img-index/m-img${j*6+6}.jpg" /></a>
							</dt>
							<dd>
								<span><a href="#">￥ 8.8</a></span>
								<p>新款OPPOR9/r11S/A59/vivoX7/x9/X20/y67苹果6S/7/8plus手机壳</p>
...
for(var i=0;i<5;i++){
	str3 +=`<a href="#">
			<img src="./static/img-index/hot${i+1}.jpg"/>
		 </a>`
}
$(".h_goods").html(str3);

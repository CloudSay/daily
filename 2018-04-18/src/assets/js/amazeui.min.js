	...
	return function t(e, i, n) {
		...
		11: [function(t, e, i) {
			(function(i) {
				...
				var o = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null,
					s = (t(2), window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
			...
			(function(i) {
				...
				function n(t, e) {
					return this.each(function() {
						var i = o(this),
							n = i.data("amui.modal"),
							s = o.extend({}, d.DEFAULTS, "object" == typeof t && t);
				...
				d.DEFAULTS = {
					...
					if(!this.active && this.$element.length) {
						t && (this.relatedTarget = t), this.transitioning && (clearTimeout(e.transitionEndTimmer), e.transitionEndTimmer = null, e.trigger(i.transitionEnd).off(i.transitionEnd)), n && this.$element.show(), this.active = !0, e.trigger(o.Event("open.modal.amui", {
							relatedTarget: t
						})), a.open(e), e.show().redraw(), n || this.isActions || (s && (s = parseInt(s, 10), d.width = s + "px", d.marginLeft = -parseInt(s / 2) + "px"), r ? (r = parseInt(r, 10), d.marginTop = -parseInt(r / 2) + "px", this.$dialog.css({
							height: r + "px"
						})) : d.marginTop = -parseInt(e.height() / 2, 10) + "px", e.css(d)), e.removeClass(i.className.out).addClass(i.className.active), this.transitioning = 1;
						var u = function() {
			...
			(function(i) {
				...
				d.DEFAULTS = {
					...
					if(i.length && !i.hasClass("am-active")) {
						...
						}).width(), a.css("margin-top", -1 * o.y), setTimeout(function() {
			...
			(function(i) {
				...
				Q.prototype = {
					...
					process: function(t) {
						...
						else if(t.eventType & Et) this.reset(), this._timer = n(function() {
			...
			(function(i) {
				...
				c.prototype.createDefault = function(t) {
					...
					for(var e, i, n, o, s = t.getModuleCount(), a = this.options.height / this.options.width, r = '<svg xmlns="http://www.w3.org/2000/svg" width="' + this.options.width + 'px" height="' + this.options.height + 'px" viewbox="0 0 ' + 10 * s + " " + 10 * s * a + '">', l = "<path ", u = ' style="stroke-width:0.5;stroke:' + this.options.foreground + ";fill:" + this.options.foreground + ';"></path>', c = ' style="stroke-width:0.5;stroke:' + this.options.background + ";fill:" + this.options.background + ';"></path>', h = 0; s > h; h++)
						for(var p = 0; s > p; p++) e = 10 * p, n = 10 * h * a, i = 10 * (p + 1), o = 10 * (h + 1) * a, r += l + 'd="M ' + e + "," + n + " L " + i + "," + n + " L " + i + "," + o + " L " + e + "," + o + ' Z"', r += t.modules[h][p] ? u : c;
					return r += "</svg>", d(r)[0]
				}, s.prototype = {
					constructor: s,
					...
					createBytes: function(t) {
						for(var e = 0, i = 0, n = 0, o = this.rsBlock.length / 3, s = new Array, r = 0; o > r; r++)
							for(var l = this.rsBlock[3 * r + 0], d = this.rsBlock[3 * r + 1], u = this.rsBlock[3 * r + 2], c = 0; l > c; c++) s.push([u, d]);
		...
		33: [function(t, e, i) {
			(function(i) {
				...
				var o = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null,
					s = o.AMUI;
				o(n), e.exports = o.AMUI.accordion = {
					VERSION: "2.1.0",
					init: n
				}
			}).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
		...
		35: [function(t, e, i) {
			(function(i) {
				...
				var o = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null;
				t(2), o(window).on("load", n), e.exports = o.AMUI.duoshuo = {
					VERSION: "2.0.1",
					init: n
				}
			}).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
		...
		36: [function(t, e, i) {
			(function(i) {
				...
				}, o(window).on("load", n), e.exports = o.AMUI.figure = {
					VERSION: "2.0.3",
					init: n
				}
			}).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
		...
		39: [function(t, e, i) {
			(function(i) {
				...
				var o = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null;
				t(2), t(22), o(n), e.exports = o.AMUI.gotop = {
					VERSION: "4.0.2",
					init: n
				}
			}).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
		...
		40: [function(t, e, i) {
			(function(i) {
				...
				var o = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null;
				t(2), o(n), e.exports = o.AMUI.header = {
					VERSION: "2.0.0",
					init: n
				}
			}).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
		...
		44: [function(t, e, i) {
			(function(i) {
				...
				var o = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null;
				t(2), o(window).on("load", n), e.exports = o.AMUI.mechat = {
					VERSION: "2.0.1",
					init: n
				}
			}).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
		...
		47: [function(t, e, i) {
			(function(i) {
				"use strict";
				var n = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null;
				t(2), e.exports = n.AMUI.pagination = {
					VERSION: "3.0.1"
				}
			}).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
		}, {
		...
		48: [function(t, e, i) {
			(function(i) {
				...
				}, o(window).on("load", n), e.exports = o.AMUI.paragraph = {
					VERSION: "2.0.1",
					init: n
				}
			}).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
		...
		50: [function(t, e, i) {
			(function(i) {
				...
				var o = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null;
				t(2), t(24), o(n), e.exports = o.AMUI.tab = {
					VERSION: "4.0.1",
					init: n
				}
			}).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
